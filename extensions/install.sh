...
# @Description: In User Settings Edit
 # @Author: your name
 # @Date: 2019-09-30 10:39:44
 # @LastEditTime: 2019-09-30 10:45:41
...
if [ -z "${EXTENSIONS##*,tidy,*}" ]; then
    echo "---------- Install tidy ----------"
	apk add --no-cache tidyhtml-dev=5.2.0-r1 --repository http://mirrors.aliyun.com/alpine/v3.11/community
